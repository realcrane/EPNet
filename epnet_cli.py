...
def add_predict_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--results-dir", default=r"results\demo_enet")
    parser.add_argument("--warmup-frames", type=int, default=20)
    parser.add_argument("--elasticity-iteration", type=int, default=3)
    parser.add_argument("--collision-projection-threshold", type=float, default=0.004)
...
def parse_args() -> argparse.Namespace:
    ...
    predict_proxy.add_argument("--alpha-cutoff", type=float, default=0.005)
    predict_proxy.add_argument("--drive-threshold", type=float, default=0.05)
    predict_proxy.add_argument("--drive-window", type=int, default=5)
    predict_proxy.add_argument("--drive-min-frames", type=int, default=3)
    predict_proxy.add_argument("--rest-scale", type=float, default=1.0)
    predict_proxy.add_argument("--warmup-frames", type=int, default=20)
    predict_proxy.add_argument("--collision-projection-threshold", type=float, default=0.004)
    ...
    predict_proxy.add_argument("--topology-cache", default=r"results\cache\topology_epnet_tshirt.npz")
    predict_proxy.add_argument("--feature-cache-dir", default=r"results\feature_cache\demo")
    ...
    predict_proxy.add_argument("--stage-feature-mode", choices=("none", "scalar"), default="scalar")
    predict_proxy.add_argument("--stage-normalizer", type=float, default=3.0)
    ...
    train_proxy_pnet.add_argument("--epochs", type=int, default=80)
    train_proxy_pnet.add_argument("--lr", type=float, default=2e-5)
    ...
    train_proxy_pnet.add_argument("--drive-threshold", type=float, default=0.05)
    train_proxy_pnet.add_argument("--inactive-weight", type=float, default=0.03)
    train_proxy_pnet.add_argument("--time-batch-size", type=int, default=1)
    train_proxy_pnet.add_argument("--output-mode", choices=("alpha", "direct", "mask_direct", "delta_direct"), default="delta_direct")
    ...
    train_proxy_pnet.add_argument("--stage-feature-mode", choices=("none", "scalar"), default="scalar")
    ...
    train_proxy_pnet.add_argument("--topology-cache", default=r"results\cache\topology_epnet_tshirt.npz")
    train_proxy_pnet.add_argument("--feature-cache-dir", default=r"results\feature_cache\demo")
