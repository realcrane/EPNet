...
class MainConfig(Config):
    ...
    def training_iteration(self):
        return self.experiment.training_iteration

    @property
    def step_smooth_scale(self):
        return self.experiment.step_smooth_scale

    @property
    def angle_step(self):
        return self.experiment.angle_step

    @property
    def elasticity_epochs(self):
        return self.experiment.elasticity_epochs

    @property
    def elasticity_batch_size(self):
        return self.experiment.elasticity_batch_size
    ...
    def input_joints(self):
        return self.body.input_joints

    @property
    def num_time_steps(self):
        # Two leading frames are reserved for velocity and acceleration features.
    ...
    def gravity(self):
        ...
        raise ValueError(f"Unsupported gravity axis: {axis}")

    @property
    def motion_augmentation(self):
        return int(self.experiment.elasticity_batch_size * self.experiment.motion_augmentation)
